      ...
      >
        <View style={styles.coloredContainer}>
          <View style={styles.coloredRow}>
            <Text style={styles.coloredRowTextItem}>{moment(startDate).toNow()}</Text>
        ...
        <View style={styles.itemInfo}>
          ...
          <Text style={styles.requestAcceptanceInfo}>
            Request accepted on {`{Mock Accepted Date}`}
          </Text>
        </View>
      </TouchableOpacity>
    );
